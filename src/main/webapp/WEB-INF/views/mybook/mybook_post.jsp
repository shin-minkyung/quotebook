	...
	<div class="col-lg-9" id="right_side_setion">
	   ...
	   <div class="row">
	     ...
	     <div class="md-margin-section">
	     	...
	     	<form action="postQuote.do" method="post" id="writepost">
	     	<input type="hidden" name="mid" value="${quote.mid }">
	     	<input type="hidden" name="mqid" value="${quote.mqid }">
	     	<input type="hidden" name="mqquote" value="${quote.mqquote }">
		    <table>
			  <tr>
				<td colspan="3">				
				</td>				
			  ...
			  <tr>
				<td colspan="3">
                <textarea class="form-control" id="mqquote" name="mqquoteView" cols="120" rows="3" readonly="readonly">${quote.mqquote }</textarea>
				</td>		
			  </tr>
			  <tr>
			  	<td colspan="3">
			  ...
			  <tr>
			  	<td>
			  	   <input type="text" class="form-control" name="mqlang" readonly="readonly" value="${quote.mqlang }">
				  </td>
			  	<td></td>
			  	<td></td>
			  </tr>
			  <tr>
				<td colspan="3"><h5>Source of the Quote*</h5></td>					
			  </tr>
			  <tr>
			    <td></td>
				<td>
				   <input type="text" class="form-control" name="stitle" readonly="readonly" value="${quote.stitle }">
				</td>
				<td>
				   <input type="text" class="form-control" name="smaker" readonly="readonly" value="${quote.smaker }">
				</td>				
			  </tr>
			  <tr>
			    <td></td>
			    <td>
				   <input type="text" class="form-control" name="surl" readonly="readonly" value="${quote.surl }">				   
				</td>				
			 	<td><input type="text" class="form-control" name="syear" readonly="readonly" value="${quote.syear }"></td>
			  </tr>
			  ...
			  <tr>
			    <td colspan="3">
			       <input type="text" class="form-control byteLimit" name="pbtitle" id="pbtitle" limitbyte="150" placeholder="Insert the title of your question">
			    </td>
			  </tr>
			  <tr>
				 <td colspan="3">
				   <textarea class="form-control byteLimit" limitbyte="1000" name="pbcontent" id="pbcontent" rows="16" placeholder="less than 1000 byte. The text this form can contain without scrollbar is 1000 byte.(in English)  The part greater than limit will be removed"></textarea>
				 </td>				
			  </tr>		 
			  <tr>
				<td colspan="3">
